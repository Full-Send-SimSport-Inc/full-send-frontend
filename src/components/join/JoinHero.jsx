...
export default function JoinHero() {
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-accent py-10 sm:py-20 px-4 sm:px-6 text-white">
      ...
      >
        {/* Title */}
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight mb-3 sm:mb-4 leading-tight">
          Join Our Team
        </h1>

        {/* Subtitle */}
        <p className="text-sm sm:text-lg text-white/80 max-w-lg mx-auto mb-6 sm:mb-8 px-2">
          Register using the options below to become an official member and part of a great team at Full Send SimSport!
        </p>

        {/* Inline Feature Tags - Condensed for Mobile */}
