  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-accent py-20 px-6 text-white">
      ...
      <motion.div
        ...
        <p className="text-lg text-white/80 max-w-lg mx-auto mb-8">Become an official member of Full Send SimSports. Fill in your details below to become a part of a great team.
