          ...
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex items-center gap-1">
              ...
              {userRoles.includes('administrator') && (
                <a 
                  href="/wp-admin" 
                  className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-slate-500 hover:text-primary hover:bg-slate-50 transition-colors border-l ml-2 pl-4"
                >
