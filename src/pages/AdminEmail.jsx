...
import { Mail, Send, Users, User, CheckCircle2, X, ChevronDown, ChevronUp, Loader2 } from 'lucide-react';
...
import { cn } from "@/lib/utils"; // Fixed missing import causing the crash
  ...
  return (
    <div className="space-y-6 pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* RIGHT COLUMN (Recipients) - Moved to top on Mobile for better UX */}
            ...
            <CardContent className="p-4 sm:p-6 pt-0 sm:pt-0 space-y-4">
              ...
              <div className="pt-2">
                <Button
                  ...
                  className="w-full h-12 text-base font-bold shadow-lg shadow-primary/10"
                >
                  {sending ? (
